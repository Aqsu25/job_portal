...
@section('main')
    <section class="bg-gray-100 py-6">
        <div class="container">
            ...
            <nav class="mb-4">
                <a href="{{ route('home') }}" class="text-blue-500 text-sm text-decoration-none">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm p-5">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <h2 class="fw-bold text-blue-500 hover:text-gray-700">
                                    {{ $job->title }}
                                </h2>
                                ...
                                <form action="{{ route('job.like', $job->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="fs-5">
                                        @if ($job->liked(Auth::id()))
                                            <i class="fa-solid fa-heart text-red-500 fs-5"></i>
                                            {{ $job->likes->count() }}
                                        @else
