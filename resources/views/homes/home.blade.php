  ...
  <section class="relative">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center md:text-left">
      ...
      <div class="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
        <a href="#jobs" class="bg-white text-gray-900 px-6 py-3 rounded-md font-semibold hover:bg-gray-100 transition">
          Browse Jobs
        </a>
      </div>
    </div>
      ...
      <form method="GET" action="{{ route('find.jobs') }}"
        ...
        <div class="flex-1">
          ...
          <input type="text" id="location" name="location" placeholder="Job location"
            class="w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-800">e="tokyo">Tokyo
          </option>
          </select>
        </div>
      ...
      <div class="grid grid-cols-3 gap-6">
        @if ($isFeatured->isNotEmpty())
          @foreach ($isFeatured as $job)
            <div class="bg-white rounded-lg border border-gray-200 hover:border-blue-400 hover:shadow-lg transition p-3">
