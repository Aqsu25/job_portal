                        ...
                        <div class="mt-4">
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="text-sm">
                                    @forelse ($requests as $request)
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            <td class="p-3 text-gray-900">
                                                ...
                                                <p class="text-gray-400 hover:text-blue-600 transition">
                                            ...
                                            <td class="p-3 text-gray-900">
                                                <div class="flex gap-3">
                                                    <form action="{{ route('request.approve', $request->id) }}"
                                                        ...
                                                        <button type="submit"
                                                            class=""><i
                                                                class="fa-solid fa-circle-check text-green-500 fs-5"></i>
                                                            </button>
                                                    </form>
                                                    <form action="{{ route('request.reject', $request->id) }}"
                                                        ...
                                                        <button type="submit" class=""><i
                                                                class="fa-solid fa-circle-xmark text-red-500 fs-5"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="pt-6 text-center text-gray-500">
                                                No pending request!.
                                            </td>
                                        </tr>
                                    @endforelse
