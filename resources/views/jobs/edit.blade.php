    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mb-6 text-sm text-gray-500">
                ...
                <span class="font-medium text-gray-700">Edit a Job</span>
            </div>
                        ...
                        <form method="POST" action="{{ route('job_portal.update', $job->id) }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="" cols="20" rows="5"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('description', $job->description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="benefits" id="" cols="20" rows="5"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('benefits', $job->benefits) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="responsibility" id="" cols="20" rows="5"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('responsibility', $job->responsibility) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="qualifications" id="" cols="20" rows="5"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('qualifications'), $job->qualifications }}</textarea>
