...
<div class="bg-white shadow p-4 space-y-2 text-decoration-none">
    ...
    <a href="{{route('users.index')}}" class="block px-4 py-2 rounded-lg hover:bg-gray-100 text-black text-decoration-none">
        Users
    </a>
    <a href="{{route('job_portal.index')}}" class="block px-4 py-2 rounded-lg hover:bg-gray-100 text-black text-decoration-none">
        Jobs
    </a>
    <a href="{{route('companies.index')}}" class="block px-4 py-2 rounded-lg hover:bg-gray-100 text-black text-decoration-none">
        Companies
    </a>
    <a href="{{route('job_portal.index')}}" class="block px-4 py-2 rounded-lg hover:bg-gray-100 text-black text-decoration-none">
        Applications
